...
//1. Big-O of getInversionCount() is O(n^2).
//This is because the outer loop runs n times, and the inner loop runs n-1 times, so the total number of times the inner loop runs is n(n-1) = n^2 - n.
